...
((props, ref: ForwardedRef<HTMLDivElement>) => {
    ...
    const [photos, setPhotos] = useState<File[]>([]); // Assuming photos is an array of strings, update accordingly
                            ...
                            {photos.map((photo, index) => {
                                return(
                                    <div key={index} className={styles['photo-container']}>
                                        <Image width={500} height={500} src={URL.createObjectURL(photo)} alt="Photo" />
